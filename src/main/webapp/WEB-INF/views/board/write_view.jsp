	...
	<div id="wrapper">
		<div id="main">
			<div class="inner">
				...
				<h2>게시판글등록</h2>
				<form action="Rgesipanwrite" method="post"
					enctype="multipart/form-data" onsubmit="return alertSelectCategory()">
					<table>
						<tr>
							<td>목록분류</td>
						...
						<tr>
							...
							<td><input type="text" name="Rname"
								value="<%=session.getAttribute("session_id")%>" readonly></td>
						</tr>
						<tr>
							<td>제 목</td>
						...
						<tr>
							...
							</script> <textarea id="summernote" name="Rcontent" rows="25" cols="30"></textarea>
							</td>
						</tr>
						<tr>
							<td>파일 첨부</td>
						...
						<tr>
							<td>동영상 첨부</td>
							<td><input type="text" name="videourl">(유튜브소스복사해서
								붙여주세요!)</td>
						</tr>
						<tr>
  ...
  <c:choose>
	...
	<script>
		function alertSelectCategory() {
			var whatCategory = document.getElementById("Rtype");
