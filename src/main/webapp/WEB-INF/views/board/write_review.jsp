	...
	<form action="Reviewwrite" method="post" enctype="multipart/form-data">
		<table>
			<tr>
				...
				<td>
				<select name= "tranl" id="tranl">
				<c:forEach var="pt" items="${relistview}">
				<option value="${pt.tranl}">${pt.tranl}</option>
						</c:forEach>
				</select>
			...
			<tr>
				<td>글쓴이</td>
				<td><input type="text" name="id" value="<%=session.getAttribute("session_id") %>" readonly ></td>
			</tr>
			<tr>
				<td>제 목</td>
    		...
    		$(document).ready(function(){
    			$('#summernote').summernote({
      			...
      			<textarea id="summernote" name="content"  rows="25" cols="30"></textarea>
      			</td>
			</tr>
			<tr>
			<td>별점</td>
